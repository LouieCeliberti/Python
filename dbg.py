...
def doQuery(conn):
    ...
    cur.execute(
        "INSERT INTO public.\"Contacts\" (\"Firstname\", \"Lastname\", \"Email\", \"City\") VALUES( 'Bill', 'Hader', 'BillHader@icloud.com', 'Los Santos')")
    ...
    cur.execute(
        "SELECT o.\"Firstname\", o.\"Lastname\", o.\"Email\", o.\"City\", i.\"City\", i.\"State\", i.\"Mayor\", i.\"Inception\" FROM public.\"Contacts\" o INNER JOIN public.\"Cities\" i ON o.\"City\" = i.\"City\"")
